...
export default async function AchievementsPage() {
  ...
  const progress = await getProducerAchievements(user.id);

  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">Premiações</h1>
        <p className="text-sm text-muted-foreground">O seu nível sobe automaticamente com cada venda confirmada.</p>
      </div>
